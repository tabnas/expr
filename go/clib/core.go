...
//
// libtabnasexpr is the expr format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/expr/go"
	host "github.com/tabnas/jsonic/go"
)

const (
	templateVersion = "v4"
	libName         = "libtabnasexpr"
	formatName      = "expr"
	valueOut        = true
...
// newParser builds one engine with the expr grammar installed
...
// parseWith answers whether src is in the expr language — and,
